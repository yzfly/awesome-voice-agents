...
| [Hail](https://github.com/hail-hq/hail) | ![GitHub Repo stars](https://badgen.net/github/stars/hail-hq/hail) | Self-hostable (AGPLv3) phone, SMS & email layer for voice AI agents: give an agent a real phone number, SMS line, and inbox — place/receive calls (Twilio + realtime LLM), send SMS, and send/receive email (AWS SES), all as tool calls over a remote MCP server, CLI, SDK, or REST. | 面向语音 Agent 的自托管电话+短信+邮件层，提供 MCP 远程服务 |
