...
| [Hail](https://github.com/hail-hq/hail) | ![GitHub Repo stars](https://badgen.net/github/stars/hail-hq/hail) | Phone, SMS & email for AI agents. One remote MCP server exposing call, email, and event tools, inbound and outbound; also usable via CLI, Python SDK, and OpenAPI. Self-hostable. | 面向 AI Agent 的电话、短信与邮件，一个远程 MCP 服务，可自托管 |
